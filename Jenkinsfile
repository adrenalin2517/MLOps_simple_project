        ...
        stage('Clone Repository') {
            steps {
                ...
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'mlops-git-token', url: 'https://github.com/adrenalin2517/MLOps_simple_project.git']])
                }
            }
        }
        stage('Lint Code') {
